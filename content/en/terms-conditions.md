...
- **Service**: GC Cloud One LaunchPad, and its associated tools and resources
- **Downtime**: Periods when the platform is unavailable
- **Data**: Any information uploaded, store, processed, or generated within any Environment

- **Environment**: A space dedicated to a single experiment, provisioned as one of

  - Azure Subscription
  - AWS Account
  - GCP Project
- **User**: Any individual or entity granted access to an Environment
- **Experimental**: Any Environment used for Cloud Guardrail Profile 1 experiments
  - Only *unclassified* data is permitted in this Environment
- **Sensitive**: Any Environment used for Cloud Guardrail Profile 3a experiments
  - Up to *Protected B* data is permitted in this Environment
...
- Storing, or processing classified or sensitive information in an Experimental environment
  - Use of Protected data (both A and B) requires a Sensitive environment
- Storing, or processing any data above Protected B
- Engaging in unauthorized access, hacking, or security testing without prior authorization

## Data Classification and Security

- **Unclassified**: Only **unclassified** data is permitted in an Experimental environment
- **Protected Data**: Data up to **Protected B** requires a Sensitive environment
...
- **Marketplace Products**: Available but subject to licensing considerations, security assessments and conditions as set out in the [GC Cloud Framework Agreement](https://www.canada.ca/en/shared-services/corporate/publications/2024-25/evaluation-ssc-cloud-services.html).
...
For support, compliance inquiries, or further clarification, please reach out to the CIE support team at [gccolaunchpad-rampedelancementiugc@ssc-spc.gc.ca](mailto:gccolaunchpad-rampedelancementiugc@ssc-spc.gc.ca).

## Applicable Policies

- [Cloud Services - Canada.ca](https://www.canada.ca/en/government/system/digital-government/digital-government-innovations/cloud-services.html)
- [Security of Online Government Services - Canada.ca](https://www.canada.ca/en/government/system/digital-government/online-security-privacy.html)
- [Responsible Use of AI in Government - Canada.ca](https://www.canada.ca/en/government/system/digital-government/digital-government-innovations/responsible-use-ai.html)
